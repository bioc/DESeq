...
data and test for differential expression. \\
...
library( DESeq )
countsTable <- read.delim( system.file( "data/TagSeqExample.tab", package="DESeq" ), header=TRUE, stringsAsFactors=TRUE )
...
<<>>=
library( DESeq )
exampleFile = system.file( "data/TagSeqExample.tab", package="DESeq" )
exampleFile
@
